...
![Pasted image 20260420101743](/assets/img/posts/2026-05-05-logging/Pasted image 20260420101743.png)
...
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420102204.png" alt="Nmap Scan" style="max-width:100%;border-radius:6px;">
...
```
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420102504.png" alt="Netexec Share Enumeration" style="max-width:100%;border-radius:6px;">
...
```
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420102942.png" alt="Extracting Files" style="max-width:100%;border-radius:6px;">
...
```
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420103145.png" alt="Identified Password" style="max-width:100%;border-radius:6px;">
...
```
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420103555.png" alt="Kerberos Authentication" style="max-width:100%;border-radius:6px;">
...
![Pasted image 20260420103919](/assets/img/posts/2026-05-05-logging/Pasted image 20260420103919.png) 
...
```
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420104313.png" alt="Generating Krb5" style="max-width:100%;border-radius:6px;">
...
```
![Pasted image 20260420104553](/assets/img/posts/2026-05-05-logging/Pasted image 20260420104553.png)
...
```
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420105204.png" alt="Add KeyCredential Attribute" style="max-width:100%;border-radius:6px;">
...
```
![Pasted image 20260420105408](/assets/img/posts/2026-05-05-logging/Pasted image 20260420105408.png)
...
```
![Pasted image 20260420105658](/assets/img/posts/2026-05-05-logging/Pasted image 20260420105658.png)

### WinRM via Pass-the-Hash
`MSA_Health$` was a member of Remote Management Users, so we passed the hash directly to evil-winrm.
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420105949.png" alt="Computer Member WinRm Group" style="max-width:100%;border-radius:6px;">
...
```
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420110151.png" alt="Successfully Logged In" style="max-width:100%;border-radius:6px;">
...
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420110511.png" alt="Discovered monitor.ps1" style="max-width:100%;border-radius:6px;">
...
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420110955.png" alt="Review Configuration" style="max-width:100%;border-radius:6px;">
...
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420111357.png" alt="Review Output UpdateMonitor.exe" style="max-width:100%;border-radius:6px;">
...
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420111746.png" alt="Generating Malicious Zipfile" style="max-width:100%;border-radius:6px;">
...
```
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420111952.png" alt="Uploaded Zip Archive" style="max-width:100%;border-radius:6px;">
  <p style="font-size:0.82rem;font-style:italic;font-weight:bold;color:#868686;margin-top:0.4rem;">Uploaded Zip Archive</p>
</div>

<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420112120.png" alt="Gained Shell" style="max-width:100%;border-radius:6px;">
...
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420112702.png" alt="Identified Groupmembership" style="max-width:100%;border-radius:6px;">
...
```
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420113157.png" alt="Request Certificate User" style="max-width:100%;border-radius:6px;">
...
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420113911.png" alt="UpdateSrv Permissions" style="max-width:100%;border-radius:6px;">
...
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420114232.png" alt="Incident Repotr" style="max-width:100%;border-radius:6px;">
...
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420115647.png" alt="Request Certificate" style="max-width:100%;border-radius:6px;">
...
```
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420115750.png" alt="BloodyAD Update DNS Record" style="max-width:100%;border-radius:6px;">
...
```
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420115914.png" alt="Generated Malicous Exe" style="max-width:100%;border-radius:6px;">
...
<div style="text-align:center;margin:1.5rem auto;">
  <img src="/assets/img/posts/2026-05-05-logging/Pasted image 20260420120229.png" alt="Escalated To Nt System" style="max-width:100%;border-radius:6px;">
